...
public class InoaInMemoryUserManagementAutoConfiguration extends GlobalAuthenticationConfigurerAdapter {

    private static final String DEFAULT_TENANT = "XXX";

    private final SecurityProperties securityProperties;

    private final MultiUserProperties multiUserProperties;

    InoaInMemoryUserManagementAutoConfiguration(final SecurityProperties securityProperties,
